...
struct MBRecognizerRunnerSettings
{
     ...
     * then during recognition if some recognizer changes its result's state into MB_RECOGNIZER_RESULT_STATE_VALID, the MBRecognizerRunner
 ...
 *                              Also note that returned recognition status may be MB_RECOGNIZER_RESULT_STATE_EMPTY or
 ...
 *
 * @return General state of the recognition run. If MB_RECOGNIZER_RESULT_STATE_EMPTY is returned, this means that no recognizer
 ...
 *         If MB_RECOGNIZER_RESULT_STATE_VALID is returned, this means that at least one recognizer used by the MBRecognizerRunner
 *         changed its result's state into MB_RECOGNIZER_RESULT_STATE_VALID.
 */
