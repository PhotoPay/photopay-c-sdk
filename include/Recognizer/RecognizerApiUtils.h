 ...
 * If given path to non-existing folder, MB_RECOGNIZER_ERROR_STATUS_INVALID_ARGUMENT will be returned and
 * the user's home folder will be used for storing files.
 * If given path is not writeable, MB_RECOGNIZER_ERROR_STATUS_INVALID_ARGUMENT will be returned and
 * the user's home folder will be used for storing files.
 ...
 *         MB_RECOGNIZER_ERROR_STATUS_INVALID_ARGUMENT is returned.
 */
